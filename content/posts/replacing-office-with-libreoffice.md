...
categories = ["posts"]
tags = ["libreoffice", "microsoft-office", "productivity"]
keywords = ["libreoffice", "microsoft office alternative", "open source office"]
...
*The formatting gotchas when opening `.docx` / `.xlsx` / `.pptx` files in LibreOffice and saving back. Specific examples are more useful than generalities here.*
